...
function needsDeploy(deployAddress) {
  if(constants.ACTIVE_NETWORK === constants.NETWORKS.LOCAL || constants.ACTIVE_NETWORK === constants.NETWORKS.DOCKER) return true
...
function confirmDeployment() {
  return new Promise((resolve, reject) => {
    if(PROMPT_ON_DEVELOP || (constants.ACTIVE_NETWORK !== constants.NETWORKS.LOCAL && constants.ACTIVE_NETWORK !== constants.NETWORKS.DOCKER)) {
      const options = {
        properties: {
          confirmDeployment: {
