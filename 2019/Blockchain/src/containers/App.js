    ...
    return (
      <div style={{ fontFamily: '"Helvetica Neue", Lato, sans-serif'}}>
        ...
        <footer className="footer navbar-fixed-bottom text-center text-muted">
          <small>developed with <FontAwesome name="heart"/> and <FontAwesome name="flash"/> by the <a href="https://openzeppelin.com">OpenZeppelin</a> team, adapted for GreHack by Nics</small>
        </footer>
