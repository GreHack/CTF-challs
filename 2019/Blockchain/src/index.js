...
function checkWrongNetwork(id) {
  ...
  if(onWrongNetwork) {
    console.error(`Heads up, you're on the wrong network!! @bad Please switch to the << RIGHT >> network (you can find the address and port in the challenge description).`)
  }
