...
module.exports = {
  ...
  networks: {
    ...
    docker: {
      host: constants.NETWORKS.DOCKER.url,
      port: constants.NETWORKS.DOCKER.port,
      network_id: constants.NETWORKS.DOCKER.id,
      gas: 3000000,
      gasPrice: 100000000000,
      from: constants.ADDRESSES[constants.NETWORKS.DOCKER.name]
    }
