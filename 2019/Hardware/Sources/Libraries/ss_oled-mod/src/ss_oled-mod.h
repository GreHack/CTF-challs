...
//
int oledLoadBMP(uint8_t *pBMP, int bInvert, int bRender, uint8_t *crypted);
//
...
//
int oledWriteString(int iScrollX, int x, int y, char *szMsg, int iSize, int bInvert, int bRender, uint8_t ram);
//
